...
var roundOne = function (drawCards) {
  ...
  var drawCards = `You drew <br> 1. ${playerDrawsFirstCard.name} of ${playerDrawsFirstCard.suit} <br>  2. ${playerDrawsSecondCard.name} of ${playerDrawsSecondCard.suit}. <br><br> If you wish to draw another card, input "hit" and press submit. <br><br> If you wish to proceed with your current hand, input "stand" and press submit. `;
  return drawCards;
};

// player draw third card
var playerThirdCard = function () {
  myOutputValue = `You drew <br> 1. ${playerDrawsFirstCard.name} of ${playerDrawsFirstCard.suit} <br>  2. ${playerDrawsSecondCard.name} of ${playerDrawsSecondCard.suit} <br> 3. ${playerDrawsThirdCard.name} of ${playerDrawsThirdCard.suit}. <br><br> If you wish to draw another card, input "hit again" and press submit. <br><br> If you wish to proceed with your current hand, input "stand" and press submit. `;
  return myOutputValue;
};
// player draw fourth card
var playerFourthCard = function () {
  myOutputValue = `You drew <br> 1. ${playerDrawsFirstCard.name} of ${playerDrawsFirstCard.suit} <br>  2. ${playerDrawsSecondCard.name} of ${playerDrawsSecondCard.suit} <br> 3. ${playerDrawsThirdCard.name} of ${playerDrawsThirdCard.suit} <br> 4. ${playerDrawsFourthCard.name} of ${playerDrawsFourthCard.suit}. <br><br> If you wish to draw another card, input hit and press submit. <br><br> If you wish to proceed with your current hand, input stand and press submit. `;

  return myOutputValue;
};

// player draw fifth card
var playerFifthCard = function () {
  myOutputValue = `You drew <br> 1. ${playerDrawsFirstCard.name} of ${playerDrawsFirstCard.suit} <br>  2. ${playerDrawsSecondCard.name} of ${playerDrawsSecondCard.suit} <br> 3. ${playerDrawsThirdCard.name} of ${playerDrawsThirdCard.suit} <br> 4. ${playerDrawsFourthCard.name} of ${playerDrawsFourthCard.suit} <br> 5. ${playerDrawsFifthCard.name} of ${playerDrawsFifthCard.suit}. <br><br> If you wish to draw another card, input hit and press submit. <br><br> If you wish to proceed with your current hand, input stand and press submit. `;

  return myOutputValue;
};

// PLAYERSTAND!
var playerStand1 = function () {
