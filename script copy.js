...
// gema starts with deal cards
  ...
  if (currGameMode == 'dealCards') {
    ...
    return `You had: ${displayHandArray(playerHandArray)} <br> <br> So far your sum is ${sumOfHand(playerHandArray)} <br> <br> Enter 'hit' to draw another card or 'stand' to stay at you current hand`;
  }
